...
{
	public static function getDataList($original_id) {
	...
	public static function update( $original_id, $categoryIds )
	{
		$oldCa = [];
	...
	public static function childData(&$ids, &$names, $data,$target_id, $cnt) {
