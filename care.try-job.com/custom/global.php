...
class SystemUtil extends SystemUtilBase{
	...
	public static function getNameList( $type, $idData = "" )
	{
	 ...
	 * @return unitime
	 */
	public static function createEpochTime( $t, $f ){
		switch( $f ){
			case 'now': case 'n':
				break;
	...
	//指定の年度を取得
	public static function getYearly($label = null){
	 ...
	 * @return true/false
	 */
	public static function async( $class, $method, $param = Array() )
	{
		global $HOME;
	 ...
	 * @return action属性の値。
	 */
	public static function GetFormTarget( $iMode )  //
	{
