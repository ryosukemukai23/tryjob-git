<?php
	...
	include_once 'include/adminTool/lib/anyDB.php';
	include_once 'include/adminTool/lib/mysqlDB.php';
	include_once 'include/adminTool/lib/sqliteDB.php';
	include_once 'include/adminTool/lib/sqlite3DB.php';
	include_once 'include/adminTool/lib/csvBase.php';
	include_once 'include/adminTool/lib/csv.php';
	include_once 'include/adminTool/lib/db.php';
	include_once 'include/adminTool/lib/insertScheduler.php';
	include_once 'include/adminTool/lib/installConfig.php';
	include_once 'include/adminTool/lib/installStatus.php';
	include_once 'include/adminTool/lib/installLogic.php';
	include_once 'include/adminTool/lib/misc.php';
	include_once 'include/adminTool/lib/queryBase.php';
	include_once 'include/adminTool/lib/queryWriterBase.php';
	include_once 'include/adminTool/lib/tableName.php';
	...
	$TOOL_TEMPLATE_PATH      = 'template/adminTool/'; ///<管理ツール用のテンプレートファイルのパス。
