...
function setPointMarker(){
	...
	.done(function(xml){
		...
		if(!$(xml).find("Locate").text()){
			...
			$("#pointlist").append('<span style="font-size: 1.8rem;line-height: 180%;">この地域に該当する情報はありません</span>');
		}else{
...
function MarkerSet(id,lat,lng,text,address,address2,address3,elements,num,type){
	...
	var markerOpts = {
		map: map,
		icon: 'https://chart.apis.google.com/chart?chst=d_map_pin_letter&chld='+num+'|FF3366|000000',
