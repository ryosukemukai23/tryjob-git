...
class fileexamin
{
     ...
     * @return void
     */
    static function fileExamine($filename, $html = null)
    {
     ...
     * @return void
     */
    static function fileWrite($filePath)
    {
     ...
     * @return void
     */
    static function fileIndexExamine($filename, $html = null)
    {
     ...
     * @return void
     */
    static function fileIndexWrite($filename)
    {
     ...
     * @return void
     */
    static function fileAddWrite($filePath, $html)
    {
        $f = fopen($filePath, "a");
        fwrite($f, $html);
        fclose($f);
