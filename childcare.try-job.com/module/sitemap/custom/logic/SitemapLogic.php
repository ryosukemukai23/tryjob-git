...
class SitemapLogic
{
     ...
     * @return void
     */
    static function createXml($file, $kind, $list)
    {
     ...
     */
    static function getNextSitemap($filename)
    {
        // 終了タグを追記
        fileexamin::fileExamine($filename, '</urlset>' . "\n");
     ...
     */
    static function getNextSitemapIndex($filename)
    {
        // 終了タグを追記
        fileexamin::fileIndexExamine($filename, '</sitemapindex>' . "\n");
     ...
     */
    static function getJobList($jobType = 'mid')
    {
        // ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
        // **************************************************************************************
     ...
     * @return array $list 子サイトマップに出力するURLのリスト
     */
    static function getAddsList($jobType = 'mid')
    {
     ...
     * @return array $list 子サイトマップに出力するURLのリスト
     */
    static function getCategoryList($categoryType, $jobType = 'mid')
    {
     ...
     * @return array $list 子サイトマップに出力するURLのリスト
     */
    static function getInterviewList()
    {
        // ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
