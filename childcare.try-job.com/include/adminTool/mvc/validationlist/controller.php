<?php
	...
	*/
	class AppValidationListController extends AppBaseController //
	{
		//■処理 //
		...
		*/
		...
		{
			$this->model->getValidationList();
			$this->view->drawValidationList( $this->model );
		}
