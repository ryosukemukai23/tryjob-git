 ...
 ****************************/
	...
	/* 管理用 */
	$css_file_paths['admin']['cmsldesign'] = './common/css/system/cmsldesign.css';
	...
	$css_file_paths['nobody']['import'] = './common/css/styles.css';
	$css_file_paths['nUser']['import'] = './common/css/styles.css';
	// $css_file_paths['cUser']['import'] = './common/css/styles.css';
	...
	/* スマホ用 */
	$sp_css_file_paths['nUser']['cmsldesign'] = './common/css/system/cmsldesign.css';
	$sp_css_file_paths['cUser']['cmsldesign'] = './common/css/system/cmsldesign.css';
	$sp_css_file_paths['nobody']['cmsldesign'] = './common/css/system/cmsldesign.css';
	$sp_css_file_paths['nUser']['portal_base'] = './common/css/sp/portal_base.css';
	$sp_css_file_paths['cUser']['portal_base'] = './common/css/sp/portal_base.css';
	$sp_css_file_paths['nobody']['portal_base'] = './common/css/sp/portal_base.css';
	...
	$sp_css_file_paths['cUser']['cuser'] = './common/css/sp/cuser.css';
	...
	$sp_js_file_paths['cUser']['flick']		 = './common/js/jquery.flicksimple.js';
	...
	$sp_js_file_paths['cUser']['entry'] = './common/js/entry.js';
	$sp_js_file_paths['cUser']['stripe']		 = './common/js/table_stripe.js';
