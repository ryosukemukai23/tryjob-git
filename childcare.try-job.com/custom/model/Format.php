<?PHP
	...
	class Format
	{
		 ...
		 */
		public static function createJsonData( $db, $table, $valueCol = 'id', $indexCol = 'name', $noneIndex = '', $count = null )
		{
			$row	 = $db->getRow($table);
		 ...
		 * @return 配列データ
		 */	
		public static function createCCParam( $db, $table, $valueCol = 'id', $indexCol = 'name', $noneIndex = '', $count = null )
		{
			if(strlen($noneIndex))
			{
				$result["value"] = "/";
		 ...
		 * @return 配列データ
		 */	
		public static function createParentJsCode( $colName, $childCol, $childTableName, $childSearchCol )
