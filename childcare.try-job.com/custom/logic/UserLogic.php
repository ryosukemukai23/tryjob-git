...
class UserLogic
{
	 ...
	 */
	function activateCheckController()	// 現在未使用
	{
	 ...
	 */
	public static function deleteActivateNone( $type )
	{
		// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
		global $ACTIVE_NONE;
		// **************************************************************************************
	 ...
	 */
	public static function deleteSelectUser( $type, $idList )
	{
		switch($type)
		{
	 ...
	 * @param type cUser,nUser 
	 */
	function firstAccept( $rec, $type )	// 現在未使用
	{
		// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
	 ...
	 * @param type cUser,nUser 
	 */
	public static function setFirstLimit( $db, $rec )
	{
