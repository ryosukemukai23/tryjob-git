<?php
	...
	class MailLogic
	{
		 ...
		 */
		public static function multiSend($gm, $rec, $design, $mailList)
		{
		 ...
		 * @param type ユーザテーブル名
		 */
		public static function editNotice($rec, $type)
		{
			// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
			global $MAILSEND_ADDRES;
			global $MAILSEND_NAMES;
		 ...
		 */
		public static function activateCheck($rec, $type)
		{
			// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
			global $loginUserType;
			global $loginUserRank;
		 ...
		 */
		static function sendMailByUserRec($rec, $type, $label)
		{
			// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
			global $loginUserType;
			global $loginUserRank;
		 ...
		 * @param string $type ユーザー種別
		 */
		public static function userAdminCheck($rec, $type)
		{
		 ...
		 * @param type ユーザテーブル名
		 */
		public static function userRegistComp($rec, $type)
		{
			// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
			global $loginUserType;
			global $loginUserRank;
		 ...
		 */
		public static function userDeleteComp($rec, $type)
		{
			// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
			global $loginUserType;
			global $loginUserRank;
		 ...
		 */
		public static function inquiry( $rec )
		{
			// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
			global $loginUserType;
			global $loginUserRank;
		 ...
		 */
		public static function noticeProjectActivate($type, $rec)
		{
			// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
			global $loginUserType;
			global $loginUserRank;
		 ...
		 */
		public static function noticeAttentionRequest($rec)
		{
			// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
			global $loginUserType;
			global $loginUserRank;
		 ...
		 * @param array $rec 契約レコード
		 */
		public static function noticeUserLimitRequest($rec)
		{
			// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
			global $loginUserType;
			global $loginUserRank;
		 ...
		 */
		public static function userLimitNotice($type, $table, $day)
		{
			// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
			global $loginUserType;
			global $loginUserRank;
		 ...
		 * @param string $day 通知タイミング(期限○日前)
		 */
		public static function attentionAdNotice($type, $table, $day)
		{
			// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
			global $loginUserType;
			global $loginUserRank;
		 ...
		 */
		public static function noticeReceiveMessage($rec)
		{
			// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
			global $loginUserType;
			global $loginUserRank;
		 ...
		 */
		public static function getJobAddress($type, $id)
		{
		 ...
		 */
		public static function EntryNotice($userType, $rec)
		{
			// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
			global $MAILSEND_ADDRES;
			global $MAILSEND_NAMES;
		 ...
		 * @param array $rec システム内メッセージレコード
		 */
		public static function noticeDeclinationScout($rec)
		{
			// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
			global $MAILSEND_ADDRES;
			global $MAILSEND_NAMES;
		 ...
		 */
		public static function NoticeAcceptPayment($rec)
		{
			// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
			global $loginUserType;
			global $loginUserRank;
		 ...
		 * @param array $rec 請求レコード
		 */
		public static function noticePayment($rec)
		{
			// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
			global $MAILSEND_ADDRES;
			global $MAILSEND_NAMES;
		...
		public static function getcUserIdList($table, $type)
		{
			$db = GMList::getDB($type);
		...
		public static function getcUserMailList($idList)
		{
		 ...
		 * @param array $rec ユーザーレコード
		 */
		public static function noticeResigns($type, $rec)
		{
			// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
			global $loginUserType;
			global $loginUserRank;
		 ...
		 * @param array $rec 契約レコード
		 */
		public static function noticePaymentCancel($rec)
		{
			// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
			global $MAILSEND_ADDRES;
			global $MAILSEND_NAMES;
		 ...
		 */
		public static function noticeAttentionAddsUser($targetType, $targetID)
		{
			// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
			global $loginUserType;
			global $loginUserRank;
		 ...
		 * @param array $rec 応募レコード
		 */
		public static function sendEntryStatusChenge($rec)
		{
			// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
			global $loginUserType;
			global $loginUserRank;
		 ...
		 * @param array $rec 請求レコード
		 */
		public static function NoticeCancelPayment($rec)
		{
			// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
			global $MAILSEND_ADDRES;
			global $MAILSEND_NAMES;
		 ...
		 */
		public static function noticeGiftPay($rec)
		{
			// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
			global $MAILSEND_ADDRES;
			global $MAILSEND_NAMES;
		 ...
		 * @param array $rec 契約レコード
		 */
		public static function noticeApplyPay($rec)
		{
			// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
			global $MAILSEND_ADDRES;
			global $MAILSEND_NAMES;
		 ...
		 * @param array $rec 契約レコード
		 */
		public static function noticeEmploymentPay($rec)
		{
			// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
			global $MAILSEND_ADDRES;
			global $MAILSEND_NAMES;
		 ...
		 * @param array $rec 契約レコード
		 */
		public static function noticeScoutMailReaded($rec)
		{
			// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
			global $MAILSEND_ADDRES;
			global $MAILSEND_NAMES;
		 ...
		 */
		public static function noticeScoutPay($rec, $messageID)
		{
			// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
			global $MAILSEND_ADDRES;
			global $MAILSEND_NAMES;
		 ...
		 */
		public static function noticeScoutApplyPay($rec, $nUserID, $jobID)
		{
			// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
			global $MAILSEND_ADDRES;
			global $MAILSEND_NAMES;
		 ...
		 * @param array $rec 請求レコード
		 */
		public static function noticeBill($rec)
		{
			// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
			global $MAILSEND_ADDRES;
			global $MAILSEND_NAMES;
		 ...
		 */
		public static function noticeInterviewActivate($rec)
		{
			// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
			global $loginUserType;
			global $loginUserRank;
		 ...
		 */
		public static function noticeNewPending($rec, $type, $mode)
		{
			// ** conf.php で定義した定数の中で、利用したい定数をココに列挙する。 *******************
			global $MAILSEND_ADDRES;
			global $MAILSEND_NAMES;
		 ...
		 */
		private static function getcUserMail($owner)
		{
