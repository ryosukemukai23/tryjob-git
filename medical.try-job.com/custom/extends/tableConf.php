...
/****     sample
    ...
    $THIS_TABLE_IS_NOACCURACY[ $EDIT_TYPE ] = true;								// テーブルへのデータ追加時の排他ロックを無効にするならtrueを指定。
...
//以下任意項目
	...
	$THIS_TABLE_MODEL_CLASS[ $EDIT_TYPE ]	  = 'Sample';								//モデルクラス名(BaseModelを継承したSampleModelを参照する
...
/**********          taskの定義          **********/
	...
	$LOGIN_KEY_COLUM[ $EDIT_TYPE ]        = null;
	$LOGIN_PASSWD_COLUM[ $EDIT_TYPE ]     = null;
	$LST[ $EDIT_TYPE ]                    = 'system/task.csv';
	$TDB[ $EDIT_TYPE ]                    = 'system/task.csv';
	$ID_HEADER[ $EDIT_TYPE ]              = '';
	$ID_LENGTH[ $EDIT_TYPE ]              = 0;
