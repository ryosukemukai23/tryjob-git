...
class pay_jobLogic{
	 ...
	 */
	static function getJobTermType($jobType,$jobID){
	...
	static function addLogCommon($type,$rec){
	...
	//スカウト時
	static function scoutAdvance($cUserID,$nUserID,$messageID){
		$taxRate = SystemUtil::getSystemData("tax");
	...
	//応募時
	static function scoutDeferred($cUserID,$nUserID,$jobID){
		$taxRate = SystemUtil::getSystemData("tax");
		$cost = systemUtil::getTableData("scout", "SC001", "cost");
		$cost = $cost + ceil($cost * $taxRate/100);
	...
	//既読課金
	static function scoutRead($cUserID,$nUserID){
		$taxRate = SystemUtil::getSystemData("tax");
		$cost = systemUtil::getTableData("scout", "SC001", "cost");
		$cost = $cost + ceil($cost * $taxRate/100);
		$thread_id = threadLogic::getThreadID($cUserID,$nUserID);
